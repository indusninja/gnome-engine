========================================================================
		CONSOLE APPLICATION : GnomeEngine3 Project Overview
========================================================================

This is a demo application for the GnomeEngine3 (OpenGL engine), including source 
code of the engine and some game logic as well.

This file contains a summary of what you will find in some of the files that
make up the GnomeEngine3 application along with directions for use and interaction 
with the application.

\Game\game.cpp
    	This is the main application source file. The file contains handlers for OpenGL
