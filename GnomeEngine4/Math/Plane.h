// Plane.h : Plane class used primarily for collision detection.
...
{
public:
	Point3 pointInPlane;		// point on the plane
	Vector3 normal;				// normal to the plane

	void init(Point3, Vector3);
	float ComputePointPlaneHalfSpace(Point3);
